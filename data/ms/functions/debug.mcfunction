...
execute if entity @a[team=HaveMaterial,gamemode=adventure] run tellraw @s [{"text":"HaveMaterialPlayer","color":"gold"},{"text":": ","color":"white"},{"text":"true","color":"green"}]
execute unless entity @a[team=HaveMaterial,gamemode=adventure] run tellraw @s [{"text":"HaveMaterialPlayer","color":"gold"},{"text":": ","color":"white"},{"text":"false","color":"green"}]