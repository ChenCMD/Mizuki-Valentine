...
execute as @a[x=1125.5,y=24.0,z=686.5,dx=6,dy=3,dz=0,team=HaveMaterial,gamemode=adventure] at @s run function ms:goal

execute as @a[team=HaveMaterial,gamemode=adventure] at @s run effect give @a[team=Player] speed 1 2 true
...
execute if score $isPlay Global matches 0 store result score $DisplayMaterialCount Global if entity @a[tag=!NotPlay]
execute if score $isPlay Global matches 0 run scoreboard players operation $DisplayMaterialCount Global -= $NoHaveMaterialPlayer Global
execute if score $isPlay Global matches 0 if score $MaterialGlowingTime Global matches ..0 if score $DisplayMaterialCount Global matches ..0 run title @a actionbar [{"text":"Setting - ","color":"white"},{"text":"高級なチョコ素材の数","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$DisplayMaterialCount"},"color":"dark_red"},{"text":"個","color":"dark_red"},{"text":"  |  ","color":"white"},{"text":"チョコ素材発光までの時間","color":"aqua"},{"text":": ","color":"white"},{"text":"無し","color":"light_purple"}]
execute if score $isPlay Global matches 0 if score $MaterialGlowingTime Global matches 1.. if score $DisplayMaterialCount Global matches ..0 run title @a actionbar [{"text":"Setting - ","color":"white"},{"text":"高級なチョコ素材の数","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$DisplayMaterialCount"},"color":"dark_red"},{"text":"個","color":"dark_red"},{"text":"  |  ","color":"white"},{"text":"チョコ素材発光までの時間","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$MaterialGlowingTime"},"color":"light_purple"},{"text":"秒","color":"light_purple"}]
execute if score $isPlay Global matches 0 if score $MaterialGlowingTime Global matches ..0 if score $DisplayMaterialCount Global matches 1.. run title @a actionbar [{"text":"Setting - ","color":"white"},{"text":"高級なチョコ素材の数","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$DisplayMaterialCount"},"color":"light_purple"},{"text":"個","color":"light_purple"},{"text":"  |  ","color":"white"},{"text":"チョコ素材発光までの時間","color":"aqua"},{"text":": ","color":"white"},{"text":"無し","color":"light_purple"}]
execute if score $isPlay Global matches 0 if score $MaterialGlowingTime Global matches 1.. if score $DisplayMaterialCount Global matches 1.. run title @a actionbar [{"text":"Setting - ","color":"white"},{"text":"高級なチョコ素材の数","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$DisplayMaterialCount"},"color":"light_purple"},{"text":"個","color":"light_purple"},{"text":"  |  ","color":"white"},{"text":"チョコ素材発光までの時間","color":"aqua"},{"text":": ","color":"white"},{"score":{"objective":"Global","name":"$MaterialGlowingTime"},"color":"light_purple"},{"text":"秒","color":"light_purple"}]
