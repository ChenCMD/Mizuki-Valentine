...
scoreboard players add @a[team=HaveMaterial] Point 10
...
tellraw @a [{"text":"1. ","color":"yellow","bold":true},{"selector":"@a[tag=Pointer1]","bold":false},{"text":": ","color":"white","bold":false},{"score":{"name":"$1","objective":"Point"},"color":"aqua","bold":false},{"text":"points","color":"aqua","bold":false}]
tellraw @a [{"text":"2. ","color":"gray","bold":true},{"selector":"@a[tag=Pointer2]","bold":false},{"text":": ","color":"white","bold":false},{"score":{"name":"$2","objective":"Point"},"color":"aqua","bold":false},{"text":"points","color":"aqua","bold":false}]
tellraw @a [{"text":"3. ","color":"gold","bold":true},{"selector":"@a[tag=Pointer3]","bold":false},{"text":": ","color":"white","bold":false},{"score":{"name":"$3","objective":"Point"},"color":"aqua","bold":false},{"text":"points","color":"aqua","bold":false}]
