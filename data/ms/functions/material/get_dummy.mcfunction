...
execute if score @s Random matches 0 run loot give @s loot ms:material/dummy1
execute if score @s Random matches 1 run tellraw @s [{"text":"これは義理チョコだ...","color":"gold"}]
execute if score @s Random matches 1 run loot give @s loot ms:material/dummy2